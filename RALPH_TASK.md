...
1. Work on the next incomplete criterion (marked [IN PROGRESS] or [TODO])
2. When grabbing a new [TODO] task change its state to [IN PROGRESS]
3. Check off completed criteria (change to [DONE])
4. Commit your changes frequently
5. When ALL criteria are [DONE], output: `<ralph>COMPLETE</ralph>`
